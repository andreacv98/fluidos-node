...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *K8SlicePartition) DeepCopyInto(out *K8SlicePartition) {
	*out = *in
	out.CPU = in.CPU.DeepCopy()
	out.Memory = in.Memory.DeepCopy()
	out.Pods = in.Pods.DeepCopy()
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new K8SlicePartition.
func (in *K8SlicePartition) DeepCopy() *K8SlicePartition {
	if in == nil {
		return nil
	}
	out := new(K8SlicePartition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Partition) DeepCopyInto(out *Partition) {
	*out = *in
	in.PartitionData.DeepCopyInto(&out.PartitionData)
}
...
func (in *Selector) DeepCopyInto(out *Selector) {
	*out = *in
	in.SelectorTypeData.DeepCopyInto(&out.SelectorTypeData)
}
