...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *K8SliceResourceReference) DeepCopyInto(out *K8SliceResourceReference) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new K8SliceResourceReference.
func (in *K8SliceResourceReference) DeepCopy() *K8SliceResourceReference {
	if in == nil {
		return nil
	}
	out := new(K8SliceResourceReference)
	in.DeepCopyInto(out)
	return out
}
